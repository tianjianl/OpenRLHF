...
openrlhf.cli.train_dpo \
   --save_path ${SCRATCH_DIR}/scaling_law_ckpts/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS} \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
...
if [[ ${1} != "slurm" ]]; then
    ...
    if [ ! -d ${SCRATCH_DIR}/scaling_law_ckpts/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS} ]; then
        echo "Training DPO"
...
set -x
export PYTHONPATH=/home/tli104/open-instruct:$PYTHONPATH
mkdir -p ${SCRATCH_DIR}/scaling_law_eval/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS}
bash alpaca_eval.sh ${SCRATCH_DIR}/scaling_law_ckpts/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS} > ${SCRATCH_DIR}/scaling_law_eval/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS}/eval_alpaca.log 
bash scripts/lm_eval_custom_script.sh ${SCRATCH_DIR}/scaling_law_ckpts/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS} > ${SCRATCH_DIR}/scaling_law_eval/small_beta_${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}_${MIX_OFF_POLICY_PROBS}/eval_benchmarks.log

...
#SBATCH --output="slurm_logs/dpo_pipeline_bo4_tulu.log"
#SBATCH --mem=200G
...
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 1.0
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.5
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.8
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.2
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.7
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.3
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.6
bash pipeline.sh HuggingFaceH4/ultrafeedback_binarized allenai/Llama-3.1-Tulu-3-8B-SFT 4 Skywork/Skywork-Reward-Gemma-2-27B-v0.2 0.4

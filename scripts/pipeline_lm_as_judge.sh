...
if [ ! -f ${SCRATCH_DIR}/scaling_laws/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}.jsonl ]; then
    ...
    python3 open_instruct/rejection_sampling/rejection_sampling.py \
        ...
        --model_names_or_paths $POLICY_MODEL \
...
openrlhf.cli.train_dpo \
   --save_path ${SCRATCH_DIR}/scaling_law_ckpts/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX} \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
...
if [[ ${1} != "slurm" ]]; then
    ...
    if [ ! -d ${SCRATCH_DIR}/scaling_law_ckpts/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX} ]; then
        echo "Training DPO"
...
# evaluation 
cd /home/tli104/open-instruct
bash alpaca_eval.sh ${SCRATCH_DIR}/scaling_law_ckpts/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX} > ${SCRATCH_DIR}/scaling_law_eval/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}/eval_alpaca.log 
bash scripts/lm_eval_custom_script.sh ${SCRATCH_DIR}/scaling_law_ckpts/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX} > ${SCRATCH_DIR}/scaling_law_eval/${DATASET_SUFFIX}_${POLICY_MODEL_SUFFIX}_${NUM_GENERATIONS}_${REWARD_MODEL_SUFFIX}/eval_benchmarks.log

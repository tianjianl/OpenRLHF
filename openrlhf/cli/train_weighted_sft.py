...
from openrlhf.trainer import WeightedSFTTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--score_key", type=str, default=None, help="Weight key for the dataset, if none, default to standard sft")

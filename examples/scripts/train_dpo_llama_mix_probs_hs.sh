...
#SBATCH --exclude=c001
#SBATCH --job-name="dpo"
#SBATCH --output="slurm_logs/dpo_tulu_hs_mixed.log"
#SBATCH --mem=200G
...
rm -rf ${SCRATCH_DIR}/open_rlhf_checkpoints/tulu-8b-dpo-hs-on-off-policy-probs-$1
read -r -d '' training_commands <<EOF
openrlhf.cli.train_dpo \
   --save_path ${SCRATCH_DIR}/open_rlhf_checkpoints/tulu-8b-dpo-hs-on-off-policy-probs-$1 \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \

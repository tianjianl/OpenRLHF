...
mkdir -p ${SCRATCH_DIR}/llama-3-8b-iter-dpo-ckpt
GENERATE_OUTPUT=${SCRATCH_DIR}/llama-3-8b-iter-dpo-ckpt/generate
RM_OUTPUT=${SCRATCH_DIR}/llama-3-8b-iter-dpo-ckpt/rm
MODEL_OUTPUT_PATH=${SCRATCH_DIR}/llama-3-8b-iter-dpo-ckpt/checkpoints
ITER_LOG_PATH=temp
TRAINING_ITERS=5
